...
\begin{tikzpicture}[>=Latex, scale=1.0]
  ...
  \fill[blue!75!black] (1,0.9) circle (1.5pt) node[above left=-3pt, font=\scriptsize] {$z_{B_1}$};
  \fill[orange!90!black] (2.5,0.45) circle (1.5pt)
    node[below right=-3pt, font=\scriptsize] {$z_{B_2}$};
  \fill[red!80!black] (1.3,0.81) circle (1.8pt);
  \node[red!80!black, font=\scriptsize, above right=-3pt] at (1.3,0.81) {$z_B$};
  ...
  \begin{scope}[xshift=5.0cm]
    ...
    \node[red!80!black, font=\scriptsize, right=1pt] at (1.4,0.8) {$z_B$};
