% Corsin Week 2 -- full exercise sheet (complete; important problems are also duplicated
% inline at the top of content/week-02.tex). NOT \input by main.tex -- reference source only.
\exercisesheet{2}
...
out as important -- they carry only the official (*) difficulty marker.
\end{notation}
