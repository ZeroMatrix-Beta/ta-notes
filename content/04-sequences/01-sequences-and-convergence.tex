...
\begin{tikzpicture}[>=Latex, scale=1.4]
  ...
  \begin{scope}[shift={(5.6,0)}]
    ...
    \draw[orange!90!black, thick, dotted, ->] (0.5,1.1).. controls (0.8,1.4) and (1.0,1.6).. (1.2,1.8);
    \node[orange!90!black, font=\footnotesize, left] at (0.5,1.1) {$y_n$};

    \draw[purple, thick, dotted, ->] (0.4,0.4).. controls (0.8,0.5) and (1.3,0.7).. (1.75,0.9);
    \node[purple, font=\footnotesize, left] at (0.4,0.4) {$x_n$};
    \node[red, font=\small] at (1.8,0.9) {$\times$};
