...
(\cref{ch:metric_spaces}), applied to $\varphi(s):=s\log s$ --- stated here explicitly for the
first time.
\end{remark}
...
everywhere and $f$ is convex by \cref{prop:convexity_characterizations}. But $f > 0$ everywhere,
