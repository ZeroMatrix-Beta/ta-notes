...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  \item \textbf{Not convex.} Differentiating,
    ...
    which direction to choose --- an eigenvector for the negative eigenvalue, here $(1,-1)$.
  \item \textbf{No.} Part \textbf{(a)} is already a counterexample: $g(x) := x$ and
    ...
    sums and by non-negative scalar multiples, but not by products --- which is why
