...
\begin{ainote}
Corsin marks this section \qt{not exam relevant}. It is included anyway, since the calculation is
short and the underlying idea, treating length as a functional and applying optimization to it,
