...
\begin{ainote}
Sheet 6 is the one sheet that is still incomplete. Only the problems Corsin tagged
\textbf{important} --- 6.2 and 6.7--6.12 --- were ever transcribed; 6.1 and 6.3--6.6 have not
been. Everything that \emph{is} transcribed is solved. This is a gap in the source material, not
a casualty of the restructure.
\end{ainote}
