...
it is the scalar case applied coordinatewise and summed (see the solution of \cref{ex:youngs_inequality}
...
\begin{exercise}[Proving Young's inequality, and its vector form]
\label{ex:youngs_inequality}
...
\exinfo{This exercise is Problem 1.4 of Problem Sheet 1, Analysis II, Spring Semester 2026.}
\exsol{sol:youngs_inequality}
\end{exercise}
