...
(\germanterm{Satz von Schwarz}), stated as \cref{thm:schwarz_mixed_partials} in Week 4,
...
minors --- and neither Corsin nor the Week 4 statement proves it. Lukas Krause's notes give a
...
fails --- see \cref{rem:schwarz_needs_c2} in Week 4 for the standard counterexample, which is
