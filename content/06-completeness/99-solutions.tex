...
% Correction: Claude Opus 5 (High) --- the bound read "$\leq 1+M$ for every $n$", but the $1$ is
...
\newterm{regularized}:
% Correction: Claude Opus 5 (High) --- the regularization radius was $1/m$ throughout, but the
...
% Broken into align* by Claude Opus 5 (High): as one \[...\] line the chain ran 9pt past
