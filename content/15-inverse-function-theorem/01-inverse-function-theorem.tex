...
By the Inverse Function Theorem (\cref{thm:inverse_function}), there exist open neighbourhoods $V_0 \subseteq U$ of $x_0$ and $W_0 \subseteq \mathbb{R}^n$ of $F(x_0)$ such that $F|_{V_0} : V_0 \to W_0$ is a diffeomorphism, and in particular, $F(V_0) = W_0$ is open in $\mathbb{R}^n$.
