...
again in its solution, but the course never states it. It is therefore stated here, together with
the warning that follows, which is what \cref{ex:4.6} actually turns on.
\end{ainote}
