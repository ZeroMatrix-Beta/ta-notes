% Corsin Week 3 -- full exercise sheet (3.1--3.11, complete). This week has no priority page,
% so no problem is tagged important and all of them are reproduced.
% \input by content/week-03.tex at the point where the sheet belongs in the chapter;
