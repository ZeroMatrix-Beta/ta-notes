...
$S^1 = \{(x,y)\in\mathbb{R}^2 : x^2+y^2=1\}$, which is exactly \cref{ex:6.9}\textbf{(a)}, solved
...
four points found via Lagrange multipliers in the solution to \cref{ex:6.9}\textbf{(a)}, so the
two methods agree.
\end{remark}
