...
of norms really is an equivalence relation is part \textbf{(e)} of \cref{ex:norm_equivalence_rn}.
\end{remark}
...
\begin{proof}
This is \cref{ex:norm_equivalence_rn}, whose five parts are exactly the five steps of the argument, and it is
