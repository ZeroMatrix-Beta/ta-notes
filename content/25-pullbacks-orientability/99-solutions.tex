...
\begin{enumerate}[label=\textbf{(\alph*)}]
  ...
  \item \Cref{ex:12.9} concludes that $\int_U\psi^*\eta = \int_V\eta$, with no sign. Drop
    ...
    \cref{ex:12.9} is not a technical convenience: it is the price of upgrading an unsigned
