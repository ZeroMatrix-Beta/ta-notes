...
% Corrected 2026-08-24 (Claude Opus 5, Max): this block described a superseded draft. It said
% P = (1.10, 0.55) with grad f = (2.20, 2.20) at 45 degrees, and the comment at the marked point
% below said c = 1.815. None of the three is what the picture draws. The point is pinned by the
% path, not chosen: at x = 1.10 the path gives y = 0.6826, and the level set through it is
% c = 1.10^2 + 2*0.6826^2 = 2.142, which is the middle ellipse actually plotted.
% At P = (1.10, 0.6826): grad f = (2x, 4y) = (2.20, 2.7304), slope 1.2411; the ellipse's tangent
% there has slope -x/(2y) = -0.8058, and 1.2411 * (-0.8058) = -1.0000, so the gradient really is
% normal to the level set at the marked point.
\begin{tikzpicture}[>=Latex, scale=1.5]
  ...
  % the point P on the middle ellipse (c = 2.142, as computed in the header) and on the path:
  % path at x = 1.10 gives y = 0.28 + 0.33 + 0.0726 = 0.6826 -- c is chosen to match the point.
