# Week 12 — Differential Forms & Orientability

**Primary source:** `Corsin Nick/Class Notes/Week 12.pdf` (7 pp)
**Exercise sheet:** `exercises/Ex12_Analysis2_eng.pdf` (solutions: `Sol12_Analysis2_eng.pdf`)
**Lecture notes:** ch. 14
