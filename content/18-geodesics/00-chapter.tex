...
minimal length inside a submanifold, and characterising one takes the first genuine
...
\input{content/18-geodesics/02-geodesics-on-submanifolds.tex}
\input{content/18-geodesics/99-solutions.tex}
