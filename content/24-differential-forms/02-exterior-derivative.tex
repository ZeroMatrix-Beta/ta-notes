...
\begin{example}[The forms attached to a function and to a vector field]
...
\end{enumerate}
\exsol{sol:ai_angle_form_closed}
\end{aiexercise}
...
\end{enumerate}
\exsol{sol:ai_exterior_derivative_drill}
\end{aiexercise}
...
\exsol{sol:serra_df_wedge_lambda}
\end{exercise}
