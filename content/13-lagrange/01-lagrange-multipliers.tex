...
\begin{tikzpicture}[>=Latex, scale=1.4]
  ...
  % changes nothing else. Screen radii afterwards, all inside 1.4 as they must be:
  %   A1 1.180  A2 1.074  A3 0.743  A4 0.559  B1 0.743  B2 0.559  B3 1.180  B4 1.074.
  \coordinate (A1) at (-0.7, -0.95);
  \coordinate (A2) at (0.5, -0.95);
  \coordinate (A3) at (0.7, -0.25);
  \coordinate (A4) at (-0.5, -0.25);

  \coordinate (B1) at (-0.7, 0.25);
  \coordinate (B2) at (0.5, 0.25);
  \coordinate (B3) at (0.7, 0.95);
  \coordinate (B4) at (-0.5, 0.95);
...
\subsection{Second-order conditions on the constraint set}
...
\subsection{An application: the spectral theorem}
