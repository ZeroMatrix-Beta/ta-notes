...
\textbf{(1)}--\textbf{(3)} are checked by picking any basis $v_1,\dots,v_{n-k}$ of $T_{x_0}$
...
\exinfo{This exercise is taken from the exam of 9 August 2021, Part B, Problem 4.}
\end{exercise}
...
\end{enumerate}
\exinfo{This exercise is taken from the exam of 24 January 2022, Part A, Problem 8.}
\end{exercise}
