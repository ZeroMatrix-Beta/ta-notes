...
(\cref{sec:why_compactness_matters}) --- the Weierstrass/extreme value theorem on the compact unit
sphere.
\end{remark}
...
infinite-dimensional space where norm equivalence fails; $\mathbb{R}[x]$ is the algebraically
simplest such example, with an explicit basis and no analysis required at all.
\end{remark}
