...
two vertical edges $\theta=0,2\pi$ cancel since they are the same curve in $M$. With
...
Fundamental theorem of calculus &
  $[a,b]\subset\mathbb{R}$ & $1$ & $f$ (a $0$-form) & $f'\,dx$ \\
Green's theorem (\cref{thm:green_theorem}) &
...
Divergence theorem (\cref{thm:gauss_divergence}) &
...
\cref{thm:stokes_general} directly --- two routes to the same fact, matching
...
boundary are, in this precise sense, the same operation viewed from two sides --- which is also
