...
% Sonnet 5 (Medium)
With the exercise sheet quoted, we turn to this week's subject: finding the extrema of a
function of several variables, first freely, then subject to a constraint.
