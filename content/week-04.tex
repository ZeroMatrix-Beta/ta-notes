...
This chapter generalizes the single-variable derivative to maps between Euclidean spaces of
arbitrary dimension: the differential, the Jacobi matrix, the chain rule (including along a
path), and multivariable Taylor expansions up to the Hessian. The exercise sheet is at the end of
the chapter, in \cref{sec:week04_solutions}.
...
\cref{rem:directional_derivative_caveat}. See \texttt{OQ-25}.
\end{ainote}
...
the distinction matters; corrected above. See \texttt{OQ-27}.
\end{ainote}
