...
\begin{ainote}[TODO --- exercise statements not yet transcribed]
The priority page above is transcribed, but \textbf{the exercise statements themselves are not
yet in}: they come from \texttt{exercises/Ex8\_Analysis2\_eng.pdf}, which has not been read on
this pass. Following the convention of Weeks 4--7, the ones to reproduce are those marked
\textbf{important} --- 8.2, 8.4 and 8.5 --- with 8.5 singled out by Corsin as the one to do if
time is short.
\end{ainote}
