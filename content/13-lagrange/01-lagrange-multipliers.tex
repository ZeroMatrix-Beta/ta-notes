...
Given an ellipse $E = \left\{(x,y) \in \mathbb{R}^2 \mid \frac{x^2}{A^2} + \frac{y^2}{B^2} = 1\right\}$, find the rectangle (with sides parallel to the axes) whose vertices lie on $E$ and has the largest area. (cf.\ Michaels Bsp 7.2.7)
\end{exercise}
