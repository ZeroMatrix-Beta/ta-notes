...
\begin{tikzpicture}[scale=0.9]
  ...
  \foreach \p/\lab in {(-1.1,0.2)/x_1,(0.1,0.9)/x_2,(1.1,0.1)/x_3,(-0.2,-0.8)/x_4} {
    \fill \p circle (1.5pt);
    \draw[orange!90!black, dashed] \p circle (0.85);
  }
  \node[font=\scriptsize, below left] at (-1.1,0.2) {$x_1$};
  \node[font=\scriptsize, above] at (0.1,0.9) {$x_2$};
  \node[font=\scriptsize, right] at (1.1,0.1) {$x_3$};
  \node[font=\scriptsize, below] at (-0.2,-0.8) {$x_4$};
\end{tikzpicture}
\end{center}
\end{proof}
...
\begin{ainote}[Total boundedness, more generally]
...
\begin{ainote}[Lebesgue's covering lemma]
...
Then $f$ is uniformly continuous (\cref{def:continuous}).
\end{proposition}
