...
L)}$ --- the square root, i.e.\ the \emph{volume} itself --- the \qt{Gram determinant}; this
...
for $m<n$ --- $LL\transp$ is $n\times n$ and singular --- so the displayed formula is the
reliable half of the definition; the surrounding prose is not.
\end{ainote}
