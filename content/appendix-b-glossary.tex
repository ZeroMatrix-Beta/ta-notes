...
autonomous & autonom & A \\
boundary & Rand & 3 \\
bounded & beschränkt & 7 \\
bump function & Höckerfunktion & 25 \\
$C^k$ vector field & Vektorfeld & 22 \\
centroid & Flächenschwerpunkt & 20 \\
chain rule & Kettenregel & 10 \\
closed & abgeschlossen & 3 \\
closure & Abschluss & 3 \\
compact & kompakt & 7 \\
compactly supported & kompakt getragen & 25 \\
complete metric space & vollständiger metrischer Raum & 6 \\
completion & Vervollständigung & 6 \\
concatenation (of paths) & Verkettung & 26 \\
cone over $\Omega$ & Kegel über $\Omega$ & 20 \\
connected & zusammenhängend & 8 \\
connected component & Zusammenhangskomponente & 8 \\
...
dyadic cube & dyadischer Würfel & 19 \\
dyadic set & dyadische Menge & 19 \\
dyadic step functions & dyadische Treppenfunktionen & 19 \\
equicontinuous & gleichgradig stetig & 7 \\
equivalent (of norms) & äquivalent & 2 \\
eventually & schließlich & 4 \\
\end{tabular}
\end{center}
...
\textbf{English} & \textbf{German} & \textbf{Ch.} \\
\hline
mean value inequality & Mittelwertsatz-Ungleichung & 11 \\
metric & Metrik & 2 \\
...
outward normal derivative & Aussennormalableitung & 23 \\
partial derivative & partielle Ableitung & 9 \\
path & Weg & 8 \\
path-connected & wegzusammenhängend & 8 \\
Picard iteration & Picard-Iteration & A \\
...
$\sigma$-algebra & $\sigma$-Algebra & 19 \\
simply connected & einfach zusammenhängend & 8 \\
sink & Senke & 22 \\
smooth partition of unity & glatte Zerlegung der Eins & 25 \\
source & Quelle & 22 \\
space & Raum & 2 \\
submanifold & Untermannigfaltigkeit & 17 \\
submultiplicative & submultiplikativ & 2 \\
support (of a function) & Träger & 25 \\
supremum norm & Supremumsnorm & 7 \\
