...
% Sonnet 5 (Medium)
With the exercise sheet quoted, we turn to this week's actual subject: generalizing the
single-variable derivative to maps between Euclidean spaces of arbitrary dimension.
