...
\exinfo{This exercise is taken from Corsin Nick's class notes (Week~2, p.~7).}
\end{exercise}
...
\end{enumerate}
\exinfo{This example is taken from Sascha Brack's class notes (Week~2, p.~2).}
\end{example}
...
\exinfo{This exercise is taken from the Analysis II lecture script, p.~15.}
\exsol{sol:closure_boundary_of_ball}
\end{exercise}
...
\exinfo{This exercise is taken from J\'er\^ome Paschoud's class notes (Week~2.1, p.~6).}
\end{exercise}
