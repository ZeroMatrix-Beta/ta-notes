...
Three equivalent descriptions are on the table, each proved to characterise the same class of
sets. What they do not yet come with is practice: which description to write down for a surface
handed to you, and --- harder --- how to argue that a set is \emph{not} a submanifold at all,
where none of the three theorems will help, since each of them only ever yields a positive.
